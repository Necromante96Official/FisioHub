...
import { classifyAttendanceStatus, extractIsoDate as extractIsoDateShared, parseFieldEntriesFromLine as parseFieldEntriesFromLineShared, sanitizeProcedimentosValue as sanitizeTextShared, splitAppointmentBlocks as splitAppointmentBlocksShared } from "../domain/appointment-parser.js";
import { FISIOHUB_STORAGE_KEYS, type EvolucoesPendingBatch, type ProcessedMeta } from "../domain/fisiohub-models.js";
...
export class AgendamentosController {
    ...
    private readonly pageTemplate = APP_PATHS.pages.agendamentos;
    ...
    private sanitizeText(value: string): string {
        return sanitizeTextShared(value);
    }

    private classifyStatus(status: string): AgendamentoCategory | null {
        return classifyAttendanceStatus(status);
    }
