...
import { FISIOHUB_RUNTIME_KEYS, FISIOHUB_STORAGE_KEYS, type BackupPayload, type EvolucoesPendingBatch, type PatientRecord, type ProcessedMeta } from "../domain/fisiohub-models.js";
import { buildPatientChangeHistoryEntries, buildPatientRecordKey, mergePatientChangeHistory, parsePatientChangeHistory } from "../domain/patient-history.js";
...
export class HomeController {
    ...
    private readonly homeTemplate = APP_PATHS.pages.home;
    ...
    async bootstrap(): Promise<void> {
        this.theme.init();
        await loadTemplateIntoApp(this.appId, this.homeTemplate);
    ...
    private bindHandlers(): void {
        ...
        const tutorialDialog = document.getElementById("tutorialDialog") as HTMLDialogElement | null;
