...
import { FISIOHUB_RUNTIME_KEYS, FISIOHUB_STORAGE_KEYS, type PatientRecord } from "../domain/fisiohub-models.js";
import { buildPatientRecordKey, parsePatientChangeHistory } from "../domain/patient-history.js";
import { loadTemplateIntoApp } from "../infrastructure/template-loader.js";
import { APP_PATHS } from "../shared/paths.js";
import { buildWhatsappLink } from "../shared/phone.js";
...
export class PatientsController {
    ...
    private readonly pageTemplate = APP_PATHS.pages.pacientes;
    ...
    private openDetails(record: PatientRecord): void {
        ...
        if (whatsappLink) {
            const href = buildWhatsappLink(record.celular);
    ...
    private openRecordHistory(record: PatientRecord): void {
        ...
        window.location.href = `index.html#/registro?patient=${encodeURIComponent(recordKey)}`;
    }
