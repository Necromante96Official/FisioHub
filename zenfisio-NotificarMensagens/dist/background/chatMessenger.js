import { CHAT_TARGET_URL, CHAT_URL_PATTERNS, MESSAGE_TYPES, STORAGE_KEYS } from "../shared/constants.js";
...
const bootstrapChatModule = async (tabId) => {
    const moduleUrl = chrome.runtime.getURL("dist/content/google-chat/main.js");
...
export const testChatConnection = async () => {
    ...
    await bootstrapChatModule(tab.id);
};
